...
describe(`TRUST-125 After Migration Test`, () => {
  ...
  it("STEP 1 - Retrieves a base product and update it", async () => {
    ...
    // Get audit log and validate
    const audit2 = reporter.retrievePayload(step, "base-prod-created-audit");
    ...
    const baseProduct = await ModelFactory.product(ticket, productResponse1.data);
    ...
    // Get audit log and validate
    const audit3 = await AuditLogChecker.assertAuditLog(GTIN, constants.OPERATIONS.UPDATE_PRODUCT, baseProduct, updatedProduct);
  });
